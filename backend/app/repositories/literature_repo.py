...
class LiteratureRepository(BaseRepository):
    ...
    def filter(self, page=1, per_page=10, status=None, language=None, year_start=None, year_end=None, tag_ids=None, folder_id=None, has_pdf=None, title=None, authors=None, abstract=None):
        ...
        if tag_ids:
            from app.models.tag import LiteratureTag
            query = query.join(LiteratureTag).filter(LiteratureTag.tag_id.in_(tag_ids))
        if folder_id:
            from app.models.folder import LiteratureFolder
